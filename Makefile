...
$(NAME_CHECKER): $(OBJ_PATH) $(OBJ_EXEC_CKR)
	...
	echo "\033[32mBinary \033[1;32m$(NAME_CHECKER)\033[1;0m\032[32m created.\033[0m"

$(NAME_PS): $(OBJ_PATH) $(OBJ_EXEC_PS)
	make -C $(LIB_PATH)
	$(CC) $(CFLAGS) $(OBJ_EXEC_PS) $(LIB) -o $@ -I $(INC_PATH) -I $(LIB_PATH)includes
	echo "\033[32mBinary \033[1;32m$(NAME_PS)\033[1;0m\032[32m created.\033[0m"
